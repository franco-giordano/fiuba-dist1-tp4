...
def main():
    ...
    max_outgoing_sentinels = 1  # config_params['MAX_OUTGOING_SENTINELS']
    pongs_queue = config_params['PONGS_QUEUE']

    controller = LadderFilterController(rabbit_ip, matches_exchange_name, output_exchange_name, pongs_queue,

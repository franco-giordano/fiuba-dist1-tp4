...
from common.models.percentage_accumulator import PercentageAccumulator
from common.utils.config_setup import setup


def main():
    config_params = setup('config.ini',
                          {'PARTIAL_VICTORIES_QUEUE_NAME': False,
    ...
    input_queue_name = config_params['PARTIAL_VICTORIES_QUEUE_NAME']
